...
async function main() {
  ...
  const record = allRecords.find(r =>
    r.fields["Name"] && r.fields["Name"].toLowerCase().includes("optimize investment")
  );

  if (!record) { console.error("Could not find Optimize Investment Partners!"); process.exit(1); }
...
<head>
  ...
  <title>Optimize Investment Partners — Office Locations</title>
